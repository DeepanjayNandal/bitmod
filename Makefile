...
test-all-backends: test-db-up ## Run the suite against SQLite, PostgreSQL and MySQL
	...
	pytest tests/test_backend_search_integration.py tests/test_source_verification.py tests/test_session_resolution.py tests/test_qualification_gate.py tests/test_fuzzy_matching.py tests/test_threshold_config.py tests/test_text_search.py tests/test_packaging.py tests/test_section_hash_batching.py tests/test_namespace_persistence.py tests/test_namespace_isolation.py -v
